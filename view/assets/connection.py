...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(405, 323)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.line = QtWidgets.QFrame(self.centralwidget)
        self.line.setGeometry(QtCore.QRect(40, 260, 321, 16))
        ...
        self.inscription.setGeometry(QtCore.QRect(150, 280, 93, 28))
        self.inscription.setObjectName("inscription")
        self.valider_connection = QtWidgets.QPushButton(self.centralwidget)
        self.valider_connection.setGeometry(QtCore.QRect(160, 220, 71, 28))
        ...
        self.label.setGeometry(QtCore.QRect(140, 30, 121, 41))
        font = QtGui.QFont()
        ...
        self.error_user = QtWidgets.QLabel(self.centralwidget)
        self.error_user.setEnabled(True)
        self.error_user.setGeometry(QtCore.QRect(100, 190, 191, 16))
        ...
        self.error_user.setPalette(palette)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.error_user.setText(_translate("MainWindow", "e-mail ou mot de passe incorrect"))
